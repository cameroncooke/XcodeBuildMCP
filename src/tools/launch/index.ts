...
// Extracted exports for launch_mac_app tool
export const launchMacAppToolName = 'launch_mac_app';
export const launchMacAppToolDescription =
...
// Extracted exports for stop_mac_app tool
export const stopMacAppToolName = 'stop_mac_app';
export const stopMacAppToolDescription =
