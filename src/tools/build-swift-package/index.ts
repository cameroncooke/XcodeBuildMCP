...
// Extracted exports for reuse in plugin
export const swiftPackageBuildToolName = 'swift_package_build';

export const swiftPackageBuildToolDescription = 'Builds a Swift Package with swift build';

export const swiftPackageBuildToolSchema = {
...
export async function swiftPackageBuildToolHandler(params: {
  packagePath: string;
  targetName?: string;
