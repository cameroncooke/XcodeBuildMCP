...
describe('macos-project workflow metadata', () => {
  describe('Workflow Structure', () => {
    ...
    it('should have correct workflow name', () => {
      expect(workflow.name).toBe('macOS Project Development');
    });

    it('should have correct description', () => {
      expect(workflow.description).toBe(
        'Complete macOS development workflow for .xcodeproj files. Build, test, deploy, and manage single-project macOS applications.',
      );
    });
