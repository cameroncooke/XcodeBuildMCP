...
import * as pluginRegistry from '../../core/plugin-registry.ts';
import * as dynamicTools from '../../core/dynamic-tools.ts';
...
describe('discover_tools', () => {
  ...
  describe('workflow enabling', () => {
    ...
    it('should enable selected workflows and return success message', async () => {
      ...
      expect(result.content[0].text).toContain(
        'Use XcodeBuildMCP tools for all Apple platform development',
      );
    });
  ...
  describe('error handling', () => {
    ...
    it('should handle workflow loading errors', async () => {
      mockPluginRegistry.loadWorkflowGroups.mockRejectedValue(
