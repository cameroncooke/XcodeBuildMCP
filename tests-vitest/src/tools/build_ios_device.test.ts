    ...
    describe('test_device_proj', () => {
      const testDeviceProjTool = createMockTool(
        ...
        async (params: any) => {
          return {
            content: [
              { type: 'text', text: `✅ Tests passed for scheme ${params.scheme} on device ${params.deviceId}.` },
              { type: 'text', text: `📱 Target: iOS Device` },
      ...
      describe('parameter validation', () => {
        ...
        it('should reject missing deviceId', async () => {
          ...
          expect(result.content).toEqual([
            { type: 'text', text: "Required parameter 'deviceId' is missing. Please provide a value for this parameter." }
          ]);
          expect(result.isError).toBe(true);
        });
        ...
        it('should accept valid required parameters', async () => {
          ...
          expect(result.isError).toBe(false);
          expect(result.content).toEqual([
            { type: 'text', text: '✅ Tests passed for scheme MyScheme on device DEVICE-UUID-123.' },
            { type: 'text', text: '📱 Target: iOS Device' },
            { type: 'text', text: 'Test output:\nTest Suite \'All tests\' passed' }
          ]);
        });
    ...
    describe('test_device_ws', () => {
      ...
      describe('parameter validation', () => {
        ...
        it('should accept valid required parameters', async () => {
          ...
          expect(result.isError).toBe(false);
          expect(result.content).toEqual([
            { type: 'text', text: '✅ Tests passed for scheme MyScheme on device DEVICE-UUID-456.' },
            { type: 'text', text: '📱 Target: iOS Device' },
            { type: 'text', text: 'Test output:\nTest Suite \'All tests\' passed' }
          ]);
        });
    ...
    describe('get_device_app_path_proj', () => {
      ...
      describe('parameter validation', () => {
        ...
        it('should accept valid required parameters', async () => {
          ...
          expect(result.isError).toBe(false);
          expect(result.content).toEqual([
            { type: 'text', text: '✅ App path retrieved successfully: /path/to/build/Release-iphoneos/TestApp.app' },
    ...
    describe('install_app_device', () => {
      const installAppDeviceTool = createMockTool(
        ...
        async (params: any) => {
          return {
            content: [
              { type: 'text', text: `✅ App installed successfully on device ${params.deviceId}\n\nApp installation completed successfully` }
            ],
            isError: false
          };
        }
      ...
      describe('parameter validation', () => {
        ...
        it('should accept valid required parameters', async () => {
          ...
          expect(result.isError).toBe(false);
          expect(result.content).toEqual([
            { type: 'text', text: '✅ App installed successfully on device DEVICE-UUID-123\n\nApp installation completed successfully' }
          ]);
        });
      });
    });
    ...
    describe('launch_app_device', () => {
      ...
      describe('parameter validation', () => {
        ...
        it('should reject missing bundleId', async () => {
          ...
          expect(result.content).toEqual([
            { type: 'text', text: "Required parameter 'bundleId' is missing. Please provide a value for this parameter." }
          ]);
          expect(result.isError).toBe(true);
        });
    ...
    describe('stop_app_device', () => {
      ...
      describe('parameter validation', () => {
        ...
        it('should reject missing processId', async () => {
          ...
          expect(result.content).toEqual([
            { type: 'text', text: "Required parameter 'processId' is missing. Please provide a value for this parameter." }
          ]);
          expect(result.isError).toBe(true);
        });
    ...
    describe('stop_device_log_cap', () => {
      const stopDeviceLogCapTool = createMockTool(
        ...
        async (params: any) => {
          ...
          return {
            content: [
              { type: 'text', text: `✅ Device log capture session stopped successfully\n\nSession ID: ${params.logSessionId}\n\n--- Captured Logs ---\n${logContent}` }
            ],
            isError: false
          };
        }
