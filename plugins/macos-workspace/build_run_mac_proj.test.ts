/**
 * Tests for build_run_mac_proj plugin (re-export)
 *
 * This test file covers the re-exported build_run_mac_proj tool:
 * - Build and run macOS app from project (re-exported in workspace context)
 *
...
// Import plugin (re-export)
import buildRunMacProj from './build_run_mac_proj.js';
...
describe('build_run_mac_proj Plugin (Re-export)', () => {
  ...
  describe('Plugin Structure (Re-export)', () => {
    it('should have required plugin properties via re-export', () => {
    ...
    it('should have correct schema structure via re-export', () => {
  ...
  describe('build_run_mac_proj functionality via re-export', () => {
    it('should build and run project successfully via re-export', async () => {
