/**
 * Device Workspace Plugin: Get Device App Path Workspace
 * 
 * Gets the app bundle path for a physical device application (iOS, watchOS, tvOS, visionOS) using a workspace.
...
import { constructDestinationString } from '../../src/utils/index.js';
