...
import { z } from 'zod';
import { log, executeCommand } from '../../src/utils/index.js';
...
export default {
  ...
  schema: {
    deviceId: z.string().min(1, 'Device ID cannot be empty').describe('UDID of the device (obtained from list_devices)'),
